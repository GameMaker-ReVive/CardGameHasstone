...
public class CardData : ScriptableObject
{
    ...
    public enum CardType { AttackDamage, AttackSpeed, UnitSpeed, Defense, Critical, rangeAttack, BossAttack, MagicalAttack, UnitMaxHealth, Heal } // enum 열거형 데이터는 정수 형태로도 사용 가능
